...
BOT_TOKEN = environ.get('BOT_TOKEN', "8790084190:AAEDo6FbyxMm2AO78MPSUFHcrpaqkdSF8Lc")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003881956209'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003871070776').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1003904659158') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1003800150938')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-5205802355')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1004290112239')).split()]  # For Multiple Id Use One Space Between Each.
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1003904919991').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://YumexBot:YumexBot@cluster0.womhhqn.mongodb.net/?appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/official_animes_group')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+r3Gp5CdP-1g3YjU1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/official_animes_group') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Divyansh_Playz')
